...
<body <?php body_class(); ?>>
    ...
    <div id="page" class="site">
        <a class="skip-link screen-reader-text"
            href="#primary"><?php esc_html_e( 'Skip to content', 'juliust96' ); ?></a>
                    ...
                    <div class="col-md-4">
                        <ul class="announcement-bar__list">
                            ...
                            <li>
                                ...
                                <a href="mailto:hello@gmail.com" class="text-decoration-none">hello@gmail.com</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-8">
                        <ul class="announcement-bar__list d-flex justify-content-end">
                            <li>
        ...
        <header id="masthead" class="site-header">
            ...
            <div class="container pt-2 pb-2">
                <div class="row align-items-center">
                    <div class="col side-header__logo d-flex justify-content-center justify-content-md-start pb-2">
                        <?php the_custom_logo(); ?>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center">
                            <button class="menu-toggle" aria-controls="primary-menu"
                                ...
                                <?php esc_html_e( 'Primary Menu', 'juliust96' ); ?>
                            </button>
                        </div>
